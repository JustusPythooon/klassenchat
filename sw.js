...
self.addEventListener('push',event=>{
 ...
 event.waitUntil((async()=>{
   ...
   try{
     ...
     for(const c of windowClients)c.postMessage({type:'KLASSENCLOUD_PUSH',count,title:data.title,text:data.text});
   }catch{}

   // Bei geöffneter App aktualisiert die App nur ihren Zähler.
   // Ist sie geschlossen oder im Hintergrund, zeigt der Service Worker die
   // echte System-Benachrichtigung – genau das Verhalten, das wir brauchen.
